	...
	if adminCfg != nil && adminCfg.AdminHandler != nil && adminCfg.JWTService != nil {
		router.Route("/api/v1/admin", func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.Get("/me/gcs-config", adminCfg.AdminHandler.GetGCSConfig)
				r.Put("/me/gcs-config", adminCfg.AdminHandler.UpdateGCSConfig)
				r.Delete("/me/gcs-config", adminCfg.AdminHandler.DeleteGCSConfig)
