	...
	if adminCfg != nil && adminCfg.AdminHandler != nil && adminCfg.JWTService != nil {
		router.Route("/api/v1/admin", func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.Post("/me/cloud-storage-config/test", adminCfg.AdminHandler.TestCloudStorageConfig)
			...
			if metadataHandler != nil {
				...
				if adminCfg.OrgHandler != nil {
					...
					r.Post("/orgs/current/cloud-storage-config/test", adminCfg.OrgHandler.TestOrgCloudStorageConfig)
				}
			})
		})
	}
